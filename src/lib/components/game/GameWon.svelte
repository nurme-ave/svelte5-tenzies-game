...
<div
  ...
  class="absolute left-1/2 top-1/2 z-50 grid -translate-x-1/2 -translate-y-1/2 transform place-content-center rounded-lg bg-purple-200 px-4 py-6 text-center text-black shadow-lg sm:h-[90%] sm:w-[90%] sm:px-10 sm:py-8 lg:h-[95%]
